...
-- MAGIC To run this demo, just select the cluster `dbdemos-identity-pk-fk-angelo_sgambati` from the dropdown menu ([open cluster configuration](https://dbc-83bd8dd3-6572.cloud.databricks.com/#setting/clusters/1023-155952-59lh5w7r/configuration)). <br />
...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2FDBSQL%2Fidentity-pk-fk%2F00-Identity_PK_FK&cid=local&uid=local">
